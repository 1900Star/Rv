package com.yibao.recyclerviewdemo.loop;
...
public class BannerView<Item> extends FrameLayout {
    ...
    public BannerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.BannerViews);

        boolean hasAspectRatio = ta.hasValue(R.styleable.BannerViews_bvAspectRatio);
        float aspectRatio = ta.getFloat(R.styleable.BannerViews_bvAspectRatio, 0f);
        boolean isLoop = ta.getBoolean(R.styleable.BannerViews_bvIsLoop, true);
        mDelay = ta.getInt(R.styleable.BannerViews_bvDelay, 5000);
        mInterval = ta.getInt(R.styleable.BannerViews_bvInterval, 5000);
        mIsAuto = ta.getBoolean(R.styleable.BannerViews_bvIsAuto, true);

        mBarVisibleWhenLast = ta.getBoolean(R.styleable.BannerViews_bvBarVisibleWhenLast, true);

        int indicatorGravity = ta.getInt(R.styleable.BannerViews_bvIndicatorGravity, Gravity.CENTER);
        int barColor = ta.getColor(R.styleable.BannerViews_bvBarColor, Color.TRANSPARENT);
        float barPaddingLeft = ta.getDimension(R.styleable.BannerViews_bvBarPaddingLeft, dp2px(10));
        float barPaddingTop = ta.getDimension(R.styleable.BannerViews_bvBarPaddingTop, dp2px(10));
        float barPaddingRight = ta.getDimension(R.styleable.BannerViews_bvBarPaddingRight, dp2px(10));
        float barPaddingBottom = ta.getDimension(R.styleable.BannerViews_bvBarPaddingBottom, dp2px(10));

        int titleColor = ta.getColor(R.styleable.BannerViews_bvTitleColor, Color.WHITE);
        float titleSize = ta.getDimension(R.styleable.BannerViews_bvTitleSize, sp2px(14f));
        boolean titleVisible = ta.getBoolean(R.styleable.BannerViews_bvTitleVisible, false);

        // auto, aways, never
        mIndicatorVisible = ta.getInteger(R.styleable.BannerViews_bvIndicatorVisible, VISIBLE_AUTO);

        int indicatorWidth = ta.getDimensionPixelSize(R.styleable.BannerViews_bvIndicatorWidth, dp2px(6));
        int indicatorHeight = ta.getDimensionPixelSize(R.styleable.BannerViews_bvIndicatorHeight, dp2px(6));
        int indicatorGap = ta.getDimensionPixelSize(R.styleable.BannerViews_bvIndicatorGap, dp2px(6));
        int indicatorColor = ta.getColor(R.styleable.BannerViews_bvIndicatorColor, 0x88ffffff);
        int indicatorColorSelected = ta.getColor(R.styleable.BannerViews_bvIndicatorColorSelected, Color.WHITE);

        Drawable indicatorDrawable = ta.getDrawable(R.styleable.BannerViews_bvIndicatorDrawable);
        Drawable indicatorDrawableSelected = ta.getDrawable(R.styleable.BannerViews_bvIndicatorDrawableSelected);
        ta.recycle();
    ...
    public static void setDuration(ViewPager pager, int duration) {
        try {
